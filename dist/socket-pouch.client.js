...
function SocketPouch(opts, callback) {
  var api = this;
  var sock; // optional existing sockIO
  ...
  function createNewSocket(sock) {
    // to force XHR during debugging
    // opts.socketOptions = {transports: ['polling']};
    var socket;
    if (sock) {
      socket = api._socket = sock; // reuse external socket
    } else {
      socket = api._socket = new Socket(opts.url, opts.socketOptions || {});
    }
    ...
    if (sock) {
      ...
      log('socket - reusing externally supplied socket.', api._socketId, api._name);
      var serverOpts = {
        name: api._name,
...
},{"../shared/buffer":11,"../shared/errors":13,"../shared/isBinaryObject":14,"../shared/utils":17,"./../shared/uuid":18,"./base64":3,"./readAsBinaryString":9,"./utils":10,"_process":73,"blob-util":23,"debug":29,"engine.io-client":31,"pouchdb-promise":71}],9:[function(_dereq_,module,exports){
'use strict';
...
},{"../shared/utils":17,"./base64StringToBlobOrBuffer":4,"_process":73,"debug":29}],11:[function(_dereq_,module,exports){
...
},{"inherits":52}],14:[function(_dereq_,module,exports){
'use strict';
...
},{"./buffer":11,"./parse-message":15,"./pouchdb-clone":16,"_process":73,"inherits":52,"pouchdb-binary-util":70,"pouchdb-promise":71}],18:[function(_dereq_,module,exports){
"use strict";
...
},{"base64-js":22,"buffer":26,"ieee754":49}],27:[function(_dereq_,module,exports){
...
},{"./debug":30,"_process":73}],30:[function(_dereq_,module,exports){
...
},{"ms":66}],31:[function(_dereq_,module,exports){
...
},{"./transport":33,"./transports/index":34,"component-emitter":27,"debug":40,"engine.io-parser":42,"indexof":51,"parseqs":68,"parseuri":69}],33:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":27,"engine.io-parser":42}],34:[function(_dereq_,module,exports){
/**
 * Module dependencies
 */
...
},{"./polling":37,"component-inherit":28}],36:[function(_dereq_,module,exports){
/* global attachEvent */
...
},{"./polling":37,"component-emitter":27,"component-inherit":28,"debug":40,"xmlhttprequest-ssl":39}],37:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":33,"component-inherit":28,"debug":40,"engine.io-parser":42,"parseqs":68,"xmlhttprequest-ssl":39,"yeast":74}],38:[function(_dereq_,module,exports){
(function (Buffer){
/**
 * Module dependencies.
 */
...
},{"../transport":33,"buffer":26,"component-inherit":28,"debug":40,"engine.io-parser":42,"parseqs":68,"ws":25,"yeast":74}],39:[function(_dereq_,module,exports){
...
},{"ms":66}],42:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"./keys":43,"./utf8":44,"after":19,"arraybuffer.slice":20,"base64-arraybuffer":21,"blob":45,"has-binary2":46}],43:[function(_dereq_,module,exports){
...
},{"buffer":26,"isarray":47}],47:[function(_dereq_,module,exports){
...
},{"./handlers":55,"immediate":50}],66:[function(_dereq_,module,exports){
/**
 * Helpers.
 */
...
},{"immediate":50}],73:[function(_dereq_,module,exports){
